...
public class WalkingGrid : MonoBehaviour
{
    ...
    void CreateGrid()
    {
        grid = new WalkingNode[gridSizeX, gridSizeY];
        ...
        for (int x = 0; x < gridSizeX; x++)
        {
            for (int y = 0; y < gridSizeY; y++)
            {
                ...
                grid[x, y] = new WalkingNode(walkable, worldPoint, x, y, movementPenalty);
            }
        }
    ...
    public List<WalkingNode> GetNeighbours(WalkingNode node)
    {
        List<WalkingNode> neighbours = new List<WalkingNode>();
    ...
    public WalkingNode NodeFromWorldPoint(Vector3 worldPos)
    {
    ...
    private void OnDrawGizmos()
    {
        ...
        {
            foreach (WalkingNode node in grid)
            {
